function NutrientsTimeSeries() {
    ...
    this.preload = function () {
        var self = this;
        this.data = loadTable('./data/food/nutrients-1974-2019.csv', 'csv', 'header',
    ...
    this.draw = function () {
        ...
        // the current.
        for (var i = 0; i < this.data.getRowCount(); i++) {
            // extract each row and store in a local variable
            var row = this.data.getRow(i);
            var previous = null;
            
            // label of the nutrients
            ...
            for (var j = 1; j < numYears; j++) {
                ...
                if (previous != null) {
                    ...
                    line(this.mapYearToWidth(previous.year), this.mapPayGapToHeight(previous.percentage),
                        this.mapYearToWidth(current.year), this.mapPayGapToHeight(current.percentage));
                ...
                // Assign current year to previous year so that it is available (explain)
